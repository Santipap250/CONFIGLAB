...
export default async function KnowledgeEntryPage({
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-20">
      ...
      <h1
        lang={entry.lang}
        className="mt-2 font-[family-name:var(--font-display)] text-3xl font-semibold text-[color:var(--color-paper)] md:text-4xl"
      >
        {entry.title}
      </h1>
      ...
      <article
        lang={entry.lang}
        className="prose prose-invert max-w-none prose-headings:font-[family-name:var(--font-display)] prose-a:text-[color:var(--color-phosphor)] prose-strong:text-[color:var(--color-paper)]"
      >
